---
title: "Getting Started with FunctorFlow.jl"
subtitle: "Building your first categorical diagram"
author: "Simon Frost"
format:
  html:
    code-fold: false
...
#| output: false
using FunctorFlow
using Catlab  # required as of FunctorFlow v0.5.0 for `to_presentation`/`to_symbolic`/`define_theory`/`nparts`/`subpart`
